...
**追加箇所**: [4.9節「まとめ：掲示板の運用と仕様駆動開発の4つの原則」](../../../chapters/4章：GitHubとCursorで仕様を管理・活用する.md#49-まとめ掲示板の運用と仕様駆動開発の4つの原則)の前
...
**追加箇所**: [5.3節「なぜ「最初の1週間」が勝負なのか」](../../../chapters/5章：最初の1週間で仕様駆動開発を始める方法.md#53-なぜ最初の1週間が勝負なのか)の後
...
**追加箇所**: [6.4節「規模の定義と3つの実践方法」](../../../chapters/6章：規模別に合意形成と承認を実現する方法.md#64-規模の定義と3つの実践方法)の後
...
**追加箇所**: [10.7節「Word/ExcelからMarkdownへの変換方法」](../../../chapters/10章：レガシー文書を仕様駆動開発に取り込む方法.md#107-wordexcelからmarkdownへの変換方法)の後
...
**追加箇所**: [10.7.4節「変換後の確認と調整「構造の回復」」](../../../chapters/10章：レガシー文書を仕様駆動開発に取り込む方法.md#1074-変換後の確認と調整)の後
...
**追加箇所**: [12.7節「権限設計・変更履歴・承認フローの最適化」](../../../chapters/12章：組織全体導入のガバナンス設計.md#127-権限設計変更履歴承認フローの最適化)の後
